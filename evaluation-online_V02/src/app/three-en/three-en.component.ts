...
@Component({
  selector: 'app-three-en',
  templateUrl: './three-en.component.html',
  styleUrls: ['./three-en.component.css']
})
export class ThreeEnComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.listAMovies = [{
      ...
      sinopse: "Shot documentary-style, this film follows the daily grind of two young police officers in LA who are partners and friends, and what happens when they meet criminal forces greater than themselves.",
    }, {
      id: "14",
      rec: ['Recent-Items'],
    ...
    this.movie = {
      ...
      title: "END OF WATCH (2012)",
      Genre: "Genre:	Drama",
      Directed: "Directed By:	David Ayer",
      Written: "Written By:	David Ayer",
      Runtime: "Runtime:	109 minutes",
      Studio: "Studio:	Open Road Films",
      sinopse: "Young Los Angeles police officers Taylor and Zavala patrol the city's meanest streets of south central Los Angeles. Giving the story a gripping, first-person immediacy, the action unfolds through footage from the handheld HD cameras of the police officers, gang members, surveillance cameras, and citizens caught in the line of fire to create a riveting portrait of the city's most dangerous corners, the cops who risk their lives there every day, and the price they and their families are forced to pay.",
    }
